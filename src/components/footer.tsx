        ...
        <div className="grid lg:grid-cols-5 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/success-stories" className="text-sm hover:text-blue-400 transition-colors">
                  Success Stories
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/security" className="text-sm hover:text-blue-400 transition-colors">
                  Security
                </Link>
              </li>
            </ul>
