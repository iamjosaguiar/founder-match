  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      <div className="container mx-auto px-4 py-16">
        ...
        {/* Pricing Preview */}
        <div className="bg-gradient-to-br from-slate-50 to-blue-50/30 backdrop-blur-sm rounded-3xl p-10 mb-24 border border-slate-200/50">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600">From matching services to full execution support</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <Card className="border-2 border-blue-500 relative transform scale-105">
              ...
              <CardHeader>
                <CardTitle>CoLaunch Pod</CardTitle>
                <div className="text-3xl font-bold text-blue-600">$3K<span className="text-sm font-normal">/sprint</span></div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
            ...
            <Card className="border-2 border-slate-200 hover:border-purple-300 transition-colors">
              <CardHeader>
                <CardTitle>Full Execution</CardTitle>
